...
2. Go to Settings ΓåÆ Posting Schedule
3. Click 'Bulk Upload' or 'Import Posts'
4. Upload the CSV file
5. Map the CSV columns to Buffer fields:
   - text ΓåÆ Post Text
   - media_path ΓåÆ Media
   - profile ΓåÆ Profile/Account
   - scheduled_at ΓåÆ Schedule Time
...
5. Map columns:
   - platform ΓåÆ Platform
   - caption ΓåÆ Caption
   - media_url ΓåÆ Media
   - scheduled_date & scheduled_time ΓåÆ Schedule
   - hashtags ΓåÆ Hashtags
